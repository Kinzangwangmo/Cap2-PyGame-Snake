...
#absolute path of the directory where your script is located
current_path = os.path.dirname(os.path.abspath(__file__))

# Append the file name to the directory path to get the absolute path
orange_path = os.path.join(current_path, 'Orange.png')
font_path = os.path.join(current_path, 'PoetsenOne-Regular.ttf')
